...
const AnalysisHighlightedTab = () => {
  return (
    <div className='col-span-12 flex flex-wrap my-4 items-center justify-center gap-2'>
        ...
        <button className='border border-black text-black px-4 py-2 rounded-3xl'>
            <Link to="/blog/methodology">Methodology</Link>
        </button>
        <button className='border bg-black text-white px-4 py-2 rounded-3xl text-sm font-bold'>
...
export default AnalysisHighlightedTab
